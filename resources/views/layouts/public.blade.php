...
<body class="font-sans text-igp-text antialiased bg-igp-surface flex flex-col min-h-screen">
    <header class="bg-primary sticky top-0 z-50 shadow-md shrink-0" x-data="{ mobileMenuOpen: false }">
