<x-app-layout>
    <x-slot name="header">
        <h1 class="text-2xl font-semibold text-igp-text">Add Category</h1>
    </x-slot>

    <form method="POST" action="{{ route('admin.categories.store') }}" class="max-w-2xl space-y-4 bg-white rounded-lg shadow p-6">
        @csrf
        <div>
